   ...
   <div style="background-color: white; margin: 15px; padding: 20px 0; border-radius: 10px;">
                ...
                <div class="position-sticky" style="top: 30px;">
                    <div class="bg-white rounded shadow p-4">
                        <form id="addProductForm">
                            ...
                            <button type="submit" class="btn btn-primary btn-block mt-3" style="background-color: #0292B7;">Add to Cart</button>
                        </form>
                    </div>
                </div>
                <div class="back">
    ...
    <script>
        ...
        document.getElementById('addProductForm').addEventListener('submit', function (event) {
            ...
            const product = { code: productCode, name, price, quantity, total: price * quantity };
            cart.push(product);
